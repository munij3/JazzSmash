...
public class Enemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Generate transform for the note with a Lerp vector using the note spawn position, note despawn position, and 't' which represents the time between the note spawn position and the note despawn position (value between 0 and 1)
